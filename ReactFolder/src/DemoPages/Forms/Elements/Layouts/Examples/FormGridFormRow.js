...
export default class FormGridFormRow extends React.Component {
    ...
    changeTitle = (e) => {
        alert(this.setState({ name: e.target.value }))
                        ...
                        <div>
                            <Card className="main-card mb-3">
                                <CardBody>
                                    ...
                                    <br />
                                    <CardTitle>Customized Register Form</CardTitle>
                                    <Form>
                                        <Row>
                                            <Col md={6}>
                                                <FormGroup>
                                                    <Label for="exampleEmail11">username</Label>
                                                    <Input type="text" name="username" id="username" value={this.state.name}
                                                        placeholder="Usama ALi" onChange={this.changeTitle} />
                                                </FormGroup>
